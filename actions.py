...
class UserActions:
    ...
    # ---------------------------------------------------------
    GET_COUNT_STATUS = """ SELECT count(*) FROM reminders WHERE USER_ID = ? AND STATUS = ?; """
    ...
    # ---------------------------------------------------------
    GET_PERIOD = """ SELECT PERIOD FROM reminders WHERE STATUS = 'FACTOR' AND USER_ID = ?; """
    ...
    # ---------------------------------------------------------
    GET_ALL_ACTIVE = """ SELECT ID, MESSAGE FROM reminders WHERE STATUS = 'ACTIVE' AND USER_ID = ?; """
    ...
    # ---------------------------------------------------------
    GET_CHAT_ID = """ SELECT CHAT_ID FROM reminders WHERE STATUS = ? AND USER_ID = ? """
    ...
    # ---------------------------------------------------------
    GET_LAST_MESS_ID = """ SELECT MAX(MESS_ID) FROM reminders WHERE STATUS='REGISTER' AND USER_ID = ? """
